...
const validateCard = (card) => {
  ...
  // Remove spaces and slashes for validation
  const cardNumberDigits = card.cardNumber.replace(/\s/g, '');
  const expiryDigits = card.expiry.replace(/\//g, '');
  
  if (!/^[0-9]{16}$/.test(cardNumberDigits)) {
    errors.cardNumber = 'Card number must be 16 digits';
  }
  
  if (!/^[0-9]{4}$/.test(expiryDigits)) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const tripData = {
        ...
        notes: `Booked trip to ${selectedDestination?.name} for ${form.numTravelers} traveler(s)`
      };
          ...
          >
            ...
            <div className="option-content">
              ...
              <div className="option-meta">
                <span className="option-price">${destination.price}</span>
      ...
      <div className="payment-grid">
        <div className="payment-group">
          ...
          <input
            ...
            onChange={(e) => handleCard(e, 'cardNumber')}
            placeholder="1234 5678 9012 3456"
            className={`form-input card-input ${cardErrors.cardNumber ? 'error' : ''}`}
            maxLength="19"
          />
        ...
        <div className="payment-row">
          <div className="payment-group">
            ...
            <input
              ...
              onChange={(e) => handleCard(e, 'expiry')}
              placeholder="MM/YY"
              className={`form-input card-input ${cardErrors.expiry ? 'error' : ''}`}
              maxLength="5"
            />
            {cardErrors.expiry && (
          ...
          <div className="payment-group">
            ...
            <input
              ...
              onChange={(e) => handleCard(e, 'cvv')}
              placeholder="123"
              className={`form-input card-input ${cardErrors.cvv ? 'error' : ''}`}
              maxLength="3"
            />
            {cardErrors.cvv && (
